...
(async () => {
  ...
  await call(
    ...
    '/api/settings',
    A,
    Object.assign({}, settings, { defaultProvider: 'wenker-cloud', enableSmartFallback: false }),
  );
  ...
  const r = await call('POST', '/v1/chat/completions', K, {
    ...
    messages: [{ role: 'user', content: `Ma ${nonce}. Noi chao.` }],
    stream: false,
  });
  ...
  await call(
    ...
    '/api/settings',
    A,
    Object.assign({}, settings, { defaultProvider: 'wenker-cloud', enableSmartFallback: true }),
  );
