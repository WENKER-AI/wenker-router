...
if (!XKIRO) {
  console.error('THIEU WK_XKIRO_KEY');
  process.exit(2);
}
...
const CLOUD_MODELS = [
  {
    ...
    name: 'WENKER Cloud DeepSeek R1',
    contextWindow: 64000,
    isFree: true,
    targetModel: 'mistralai/devstral-medium',
  },
  {
    id: 'wenker-deepseek-v3-free',
    name: 'WENKER Cloud DeepSeek V3',
    contextWindow: 64000,
    isFree: true,
    targetModel: 'mistralai/codestral-2508',
  },
  {
    id: 'wenker-qwen-2.5-coder-free',
    name: 'WENKER Cloud Qwen Coder',
    contextWindow: 32768,
    isFree: true,
    targetModel: 'mistralai/codestral-2508',
  },
  {
    ...
    name: 'WENKER Cloud Llama 3.3 70B',
    contextWindow: 128000,
    isFree: true,
    targetModel: 'mistralai/mistral-large-2512',
  },
  {
    id: 'wenker-mistral-nemo-free',
    name: 'WENKER Cloud Mistral NeMo',
    contextWindow: 32000,
    isFree: true,
    targetModel: 'mistralai/mistral-medium-3.5',
  },
  {
    id: 'wenker-gpt-4o-mini-free',
    name: 'WENKER Cloud GPT-4o mini',
    contextWindow: 128000,
    isFree: true,
    targetModel: 'mistralai/ministral-8b',
  },
  {
    id: 'wenker-gemini-2.5-free',
    name: 'WENKER Cloud Gemini Flash',
    contextWindow: 1000000,
    isFree: true,
    targetModel: 'mistralai/mistral-small-2603',
  },
];
...
(async () => {
  ...
  const r = await call('POST', '/api/providers/wenker-cloud', A, {
    ...
    models: CLOUD_MODELS,
    description:
      'WENKER Cloud (basic) - dinh tuyen toi xkiro. Ten model ben duoi la ALIAS; model that tra loi la slug xkiro o cot targetModel (xem Nhat Ky).',
    keyHelp:
      'Da noi key xkiro. Khong can lam gi them. Neu xkiro bao 403 \'premium\' thi do model do can so du; cac model dang day la loai mien phi trong goi.',
  });
  ...
  console.log(
    `  [wenker-cloud] enabled=${p?.enabled} baseUrl=${p?.baseUrl} hasKey=${p?.hasApiKey} models=${(p?.models || []).length}`,
  );
