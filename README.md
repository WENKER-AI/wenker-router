...
> ⚠️ 本项目与文中提到的任何商标持有人无隶属关系。供应商 Logo 仅用于**指代与致谢**，版权归各自所有者。
...
> **OFF. 有东西不太对劲……**（"糟了，这里出了点问题"）

页面下嵌了三个可玩的像素小游戏，共用一块 canvas：

| 游戏 | 玩法 | 操作 |
|---|---|---|
| 🐍 贪吃蛇  | 吃点变长，撞墙/撞自己结束 | 方向键 / WASD |
| 🐟 接小鱼  | 移动篮子接住掉落的鱼，漏 3 条结束 | 左右键 / 拖动 |
| 🐋 飞天鲸  | Flappy 式，穿过管道缝隙 | 空格跳跃 / 点击 |
...
<p align="center"><sub>Made with 🐋 by arist999 · 一个端口，统一所有 AI。</sub></p>
